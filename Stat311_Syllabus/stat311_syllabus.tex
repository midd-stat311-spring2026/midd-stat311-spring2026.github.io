...
\customsection{Tentative Course Content}
 ...
 \noindent \emph{(Last updated: 02/08/26)}
...
\textbf{1} & 2/09 & M -  Welcome! Course logistics, Intro to Inference \\
	...
	\hline   
	\textbf{2} & 2/16 & M  - Maximum Likelihood Estimators (MLEs), 1-D   \\
%&& \quad \ - Problem Set 01 due\\
	&& W -   MLEs cont.  \\
	&& \quad \ - Problem Set 01 due\\
 && F -  Properties of MLEs  \\
%\textbf{2} & 2/16 & M - Computing posteriors  \\
	%&& W -   Conjugate Prior Distributions  \\
% && F - Bayes estimators  \\
	\hline   
\textbf{3} 	& 2/23 & M   - Method of Moments  \\
        & & W -   Properties of estimators: consistency  \\
