...
\begin{enumerate}
    ...
    \item Homework problems: After each class session, a few homework problems will be assigned to the weekly problem set. Some these problems will require the use of R.
\end{enumerate}
...
\begin{itemize}
    \item \orangetext{Midterm 1: Thursday 3/19} 
    \item \orangetext{Midterm 2: Thursday 4/30}
\end{itemize}
...
\customsection{Tentative Course Content}
 ...
 \noindent \emph{(Last updated: 02/12/23)}
