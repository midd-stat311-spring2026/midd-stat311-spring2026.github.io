...
a)  Suppose $X_{1},\ldots, X_{n}$ are an IID random sample for $N(0,1)$. First set a seed of your choice. Then use `R` to simulate `nsim = 10000` sample data sets (consider making this a variable), each of size $n=6$. Make it such that your resulting matrix has 10000 rows and 6 columns moving forward.
